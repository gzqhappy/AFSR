...
def load_images(images_file_path, batch_size, prefix='/Data_SSD/zhiqiang/Dataset-UDA', resize_size=256, is_train=True,
    ...
    if not is_train:    # evaluation
        ...
        # images_loader = util_data.DataLoader(images, batch_size=batch_size, shuffle=True, num_workers=num_worker, drop_last=True)
        images_loader = util_data.DataLoader(images, batch_size=batch_size, shuffle=True, num_workers=num_worker, drop_last=True)
